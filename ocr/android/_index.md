...
{{< blocks/products/pf/upper-banner h1="Android REST API to Build OCR Cloud Apps" h2="Develop Mobile Apps for Android devices to perform optical character recognition on raster images (BMP, JPG, GIF, PNG, TIFF) & automated image pre-processing in the cloud." logoImageSrc="/headers/aspose_ocr-for-android.png" pfName="Aspose.OCR" subTitlepfName="SDK for Android" downloadUrl="" >}}
